...
import com.CSplashAluguel.DTO.Request.CadastroRequest;
import com.CSplashAluguel.DTO.Request.LoginRequest;
import com.CSplashAluguel.DTO.Response.LoginResponse;
import com.CSplashAluguel.DTO.Response.UsuarioResponse;
import com.CSplashAluguel.Model.Usuario;
import com.CSplashAluguel.Security.TokenService;
import com.CSplashAluguel.Service.AutenticacaoService;
import com.CSplashAluguel.Service.UsuarioService;
...
public class AutenticacaoController {
    ...
    public ResponseEntity<LoginResponse>login(@RequestBody LoginRequest request){
        ...
        return  ResponseEntity.status(HttpStatus.ACCEPTED).body(new LoginResponse(token, usuarioResponse));
    }
